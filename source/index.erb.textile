...
<div id="subCol">
  <dl>
    <dd class="warning">This Guide is based on Spree 0.8.x. Some of the code shown here will not work in older versions of Spree.  This guide is also incomplete in some areas and will likely not be completed.  Most of the documentation effort is now focused on the "edge" version of the code.  Please refer to the "current version":/documentation as well since it may contain updated documentation that still applies to older versions of Spree.
    </dd>
  </dl>
</div>
